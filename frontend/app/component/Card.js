...
function PatientName({text}) {
    return(
      ...
      <h1 className="text-3xl font-bold text-blue-900 px-2 self-start">{text}</h1>
      </div>
    );
  }
        ...
        <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="space-y-4">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-gray-900">Kalash Chowk near new Amritsar, Gopalganj, Bihar</span>
            </div>
          </div>
        </div>
  
        <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6">
          <h3 className="text-lg font-bold text-blue-900 mb-2">Current Diagnosis</h3>
          <p className="text-gray-900">
            Acute Coronary Syndrome (ACS), with underlying Type 2 Diabetes and Hypertension.
          </p>
        </div>
      </div>
    );
